<?php
/*xiaotong/20220214/20190105*/
namespace _vendor_krumo_;
/*end by xiaotong*/
/**
...
{
	define('KRUMO_TRUNCATE_LENGTH',1024);
}
...
<!--end by xiaotong-->
	...
	*/
	private static function _array(&$data, $name)
	{
		?>
		<li class="krumo-child">
<!--xiaotong/20220214/添加了krumo-opened-->
			<div <?php if (count($data) > 0) {?> onClick="krumo.toggle(this);"<?php } ?>
				class="krumo-element<?php echo count($data) > 0 ? ' krumo-expand krumo-opened' : '';?>">
